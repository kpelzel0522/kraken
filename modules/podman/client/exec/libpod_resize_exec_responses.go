...
// ContextValidate validates this libpod resize exec internal server error body based on context it is used
func (o *LibpodResizeExecInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
// ContextValidate validates this libpod resize exec not found body based on context it is used
func (o *LibpodResizeExecNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
