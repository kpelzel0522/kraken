...
// ContextValidate validates this prune pods bad request body based on context it is used
func (o *PrunePodsBadRequestBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
// ContextValidate validates this prune pods internal server error body based on context it is used
func (o *PrunePodsInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
