...
// ContextValidate validates this libpod push image internal server error body based on context it is used
func (o *LibpodPushImageInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
// ContextValidate validates this libpod push image not found body based on context it is used
func (o *LibpodPushImageNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
