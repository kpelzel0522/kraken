...
type ClientService interface {
	...
	LibpodGenerateSystemd(params *LibpodGenerateSystemdParams) (*LibpodGenerateSystemdOK, error)
	...
	LibpodStatsContainers(params *LibpodStatsContainersParams) (*LibpodStatsContainersOK, error)
...
/*
  LibpodGenerateSystemd generates systemd units

  Generate Systemd Units based on a pod or container.
*/
func (a *Client) LibpodGenerateSystemd(params *LibpodGenerateSystemdParams) (*LibpodGenerateSystemdOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewLibpodGenerateSystemdParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "libpodGenerateSystemd",
		Method:             "GET",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &LibpodGenerateSystemdReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*LibpodGenerateSystemdOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for libpodGenerateSystemd: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  LibpodStatsContainers gets stats for one or more containers
...
*/
func (a *Client) LibpodStatsContainers(params *LibpodStatsContainersParams) (*LibpodStatsContainersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewLibpodStatsContainersParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "libpodStatsContainers",
		Method:             "GET",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &LibpodStatsContainersReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*LibpodStatsContainersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for libpodStatsContainers: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
