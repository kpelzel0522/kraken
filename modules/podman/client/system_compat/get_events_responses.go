...
// ContextValidate validates this get events internal server error body based on context it is used
func (o *GetEventsInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
