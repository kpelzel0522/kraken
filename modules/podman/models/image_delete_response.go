...
// ContextValidate validates this image delete response based on context it is used
func (m *ImageDeleteResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
