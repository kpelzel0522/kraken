...
func (m *HealthConfig) contextValidateInterval(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HealthConfig) contextValidateStartPeriod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HealthConfig) contextValidateTimeout(ctx context.Context, formats strfmt.Registry) error {
