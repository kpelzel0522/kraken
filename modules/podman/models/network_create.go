...
func (m *NetworkCreate) contextValidateConfigFrom(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NetworkCreate) contextValidateIPAM(ctx context.Context, formats strfmt.Registry) error {
